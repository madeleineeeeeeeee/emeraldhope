...
static const u8 sText_PkmnPeltedByHail[] = _("{B_ATK_NAME_WITH_PREFIX} is freezing\nin the snow!");
...
static const u8 sText_PkmnPerishCountFell[] = _("{B_ATK_NAME_WITH_PREFIX}'s PEerish count\nfell to {B_BUFF1}!");
...
static const u8 sText_MysteriousAirCurrent[] = _("A strong air current is\ndispelled active weather!");
static const u8 sText_StrongWindsDissipated[] = _("The strong winds\nhave dissipated!{PAUSE 64}");
