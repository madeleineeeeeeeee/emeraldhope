...
static const u8 sText_PkmnHasNoMovesLeft[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} has no\nmoves left!\p");
static const u8 sText_PkmnMoveIsDisabled[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nis disabled!\p");
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} can't use the same\nmove in a row due to the TORMENT!\p");
static const u8 sText_PkmnCantUseMoveTaunt[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} can't use\n{B_CURRENT_MOVE} after the TAUNT!\p");
static const u8 sText_PkmnCantUseMoveSealed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} can't use the\nsealed {B_CURRENT_MOVE}!\p");
...
static const u8 sText_DropsEva[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s evasion!");
...
static const u8 sText_IceBodyHpGain[] = _("{B_ATK_NAME_WITH_PREFIX} was healed by the snow!");
...
static const u8 sText_AttackerLostDarkType[] = _("{B_ATK_NAME_WITH_PREFIX} has atoned!");
static const u8 sText_Teleporting[] = _("{B_ATK_NAME_WITH_PREFIX} is\nis trying to teleport!");
static const u8 sText_LevitateUser[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} floats above the ground!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_TELEPORTING - BATTLESTRINGS_TABLE_START] = sText_Teleporting,
    [STRINGID_ATTACKERLOSTDARKTYPE - BATTLESTRINGS_TABLE_START] = sText_AttackerLostDarkType,
    [STRINGID_DROPSEVA - BATTLESTRINGS_TABLE_START] = sText_DropsEva,
    ...
    [STRINGID_LEVITATEUSER - BATTLESTRINGS_TABLE_START] = sText_LevitateUser,
};
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_LEVITATEUSER] = STRINGID_LEVITATEUSER,
};
