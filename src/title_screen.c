...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/demo_rayquaza.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/demo_rayquaza.bin.lz");
