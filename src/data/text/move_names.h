...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BASILISK_FANG] = _("Basilisk Fang"),
    [MOVE_HARPY_TALONS] = _("Harpy Talons"),
    [MOVE_MIND_FLAY] = _("Mind Flay"),
    [MOVE_SHADOW_DANCE] = _("Shadow Dance"),
    [MOVE_SPELLBREAKER] = _("Spellbreaker"),
    [MOVE_KICKFLIP] = _("Kick-Flip"),
    [MOVE_WAILING_ARROW] = _("Wailing Arrow"),
    [MOVE_MOLT] = _("Molt"),
    [MOVE_RECONSTRUCT] = _("Reconstruct"),
    [MOVE_JAGGED_EDGE] = _("Jagged Edge"),
    [MOVE_DIRE_STING] = _("Dire Sting"),
    [MOVE_SPD] = _("Pika-Driver!"),
    [MOVE_PHASE_PUNCH] = _("Phase Punch"),
    [MOVE_PHASE_ZAP] = _("Phase Zap"),
    [MOVE_SHEAR] = _("Shear"),
    [MOVE_PULVERIZE] = _("Pulverize"),
    [MOVE_SIREN_SONG] = _("Siren Song"),
    [MOVE_STATIC_JOLT] = _("Static Jolt"),
    [MOVE_BLAZE_TURN] = _("Blaze Turn"),
    [MOVE_FURRET_WALK] = _("Furret Walk"),
    [MOVE_LUCENT_BEAMS] = _("Lucent Beams"),
    [MOVE_BROADSIDE] = _("Broadside"),
    [MOVE_BUG_CRUSHER] = _("Bug Crusher"),
    [MOVE_SMITE] = _("Smite"),
    [MOVE_TWIN_SCYTHES] = _("Twin Scythes"),
    [MOVE_GRASPING_ROOTS] = _("Grasping Roots"),
    [MOVE_GLACIAL_ADVANCE] = _("Glacial Advance"),
    [MOVE_TIME_LAPSE] = _("Time Lapse"),
    [MOVE_TEMPORAL_FRAGMENT] = _("TemporalFragment"),
    [MOVE_RIBBON_DANCE] = _("Ribbon Dance"),
    [MOVE_QUICK_NOCK] = _("Quick Nock"),
    [MOVE_FLAME_RAKE] = _("Flame Rake"),
    [MOVE_WITHER] = _("Wither"),
    [MOVE_ATONEMENT] = _("Atonement"),
    [MOVE_EVOBOOST] = _("Evoboost"),
    [MOVE_ASTEROID_BELT] = _("Asteroid Belt"),
    [MOVE_PHOSPHORESCENCE] = _("Phosphorescence"),
    [MOVE_ENVENOM] = _("Envenom"),
    [MOVE_GOO_TURN] = _("Goo-Turn"),
    [MOVE_DRAKEBREATH] = _("Drakebreath"),
    [MOVE_DRAKE_RUSH] = _("Drake Rush"),
    [MOVE_TAILFLIP] = _("Tail-Flip"),
    [MOVE_BLACK_TIGER_CLAW] = _("BlackTigerClaw"),
    [MOVE_BLACK_TIGER_POUNCE] = _("BlackTigerPounce"),
    [MOVE_BEAM_CANNON] = _("Beam Cannon"),
    [MOVE_BEAM_SABER] = _("Beam Saber"),
    [MOVE_VULCAN_ARRAY] = _("Vulcan Array"),
    [MOVE_EVASIVE_MANEUVER] = _("Evasive Maneuver"),
    [MOVE_EARTH_SPIKES] = _("Earth Spikes"),
    [MOVE_MUD_PLASTER] = _("Mud Plaster"),
    [MOVE_GOLDEN_HONEY] = _("Golden Honey"),
    [MOVE_MASK_OFF] = _("Mask Off"),
    [MOVE_DRAGON_PUNCH] = _("Dragon Punch"),
    [MOVE_FORBIDDEN_DRAGON] = _("Forbidden DP"),
    [MOVE_GLIDE_COUNTER] = _("Glide Counter"),
    [MOVE_RAGING_DEMON] = _("Raging Demon"),
    [MOVE_PHANTASM] = _("Phantasm"),
    [MOVE_STIFF_DRINK] = _("Stiff Drink"),
    [MOVE_BURNING_BREATH] = _("Burning Breath"),
    [MOVE_FRIGID_TALONS] = _("Frigid Talons"),
    [MOVE_HOWLING_BLAST] = _("Howling Blast"),
    [MOVE_RUMORS] = _("Rumors"),
    [MOVE_GOSSIP] = _("Gossip"),
    [MOVE_RELIC_DANCE] = _("Relic Dance"),
    [MOVE_ACRID_AROMATIC] = _("Acrid Aromatic"),
    [MOVE_LARK] = _("Lark"),
    [MOVE_DYNAMITE_PUNCH] = _("Dynamite Punch"),
