...
static const u8 sCloudNineDescription[] = _("Dispels weather.");
...
static const u8 sMagmaArmorDescription[] = _("Coated in sealing magma.");
...
static const u8 sRivalryDescription[] = _("Drops raise speed.");
...
static const u8 sSolarPowerDescription[] = _("Ups speed in sunshine.");
...
static const u8 sIceBodyDescription[] = _("Protected by snowstorms.");
...
#endif
static const u8 sHoneyGatherDescription[] = _("Heals when holding honey.");
...
static const u8 sBigPecksDescription[] = _("Prevents recoil damage.");
...
static const u8 sPranksterDescription[] = _("Dark STAB.");
...
static const u8 sBallFetchDescription[] = _("Likes holding Poké Balls.");
...
static const u8 sBunnyHopDescription[] = _("AKA AKA AKA");
static const u8 sMoltenCoreDescription[] = _("Fire STAB.");
static const u8 sNightWarriorDescription[] = _("Immune to Dark-type moves.");
static const u8 sGraveWardenDescription[] = _("Immune to Dark-type moves.");
static const u8 sDesertSpiritDescription[] = _("Levitate and Dragon STAB.");
static const u8 sAirSuperiorityDescription[] = _("Levitate and Flying STAB.");
static const u8 sVenomousDescription[] = _("Poison STAB.");
static const u8 sAvianDescription[] = _("Flying STAB.");
static const u8 sBkcDescription[] = _("Blazin' Kickin' Chicken'");
static const u8 sConflagrateDescription[] = _("Normal moves become Fire.");
static const u8 sUmbralMirrorDescription[] = _("Obsidian glass.");
static const u8 sSpiritCallDescription[] = _("Ghost STAB.");
static const u8 sImperialDescription[] = _("Invictum Tyrannus.");
static const u8 sSeraphimDescription[] = _("True purity.");
static const u8 sInfernalDescription[] = _("Born in flames.");
static const u8 sGreatSageDescription[] = _("Survive a fatal hit once.");
static const u8 sGravityWellDescription[] = _("Moves never miss.");
static const u8 sLivingMelodyDescription[] = _("Song and dance.");
static const u8 sFaeWardDescription[] = _("Immune to poison.");
static const u8 sNastyTricksDescription[] = _("NASTY trickses!");
static const u8 sRenegadeDescription[] = _("Warps this world's laws.");
static const u8 sWorldSoulDescription[] = _("Gaia cometh.");
static const u8 sFletcherDescription[] = _("Peerless archer.");
static const u8 sGingaDescription[] = _("Revolutionary.");
static const u8 sVorpalDescription[] = _("Boosts drain and bite moves.");
static const u8 sProteonDescription[] = _("Changes type to used move.");
static const u8 sSlipstreamDescription[] = _("Rivalry + Aerilate.");
static const u8 sStarchildDescription[] = _("Spaceborne.");
static const u8 sDrakescaleDescription[] = _("Boosts defenses.");
static const u8 sMechPilotDescription[] = _("Fights in a mobile suit.");
static const u8 sInsulatedDescription[] = _("Insulating clay.");
static const u8 sAssassinFistDescription[] = _("Ruthless fighters.");
static const u8 sStaggerDescription[] = _("Delays some damage taken.");
static const u8 sFrostbroodDescription[] = _("Levitate + ghost STAB.");
static const u8 sPowerCoreDescription[] = _("Levitate + poison STAB.");
static const u8 sSinbearerDescription[] = _("Bearer of the tablets.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_BUNNY_HOP] = _("Bunny Hop"),
    [ABILITY_MOLTEN_CORE] = _("Molten Core"),
    [ABILITY_NIGHT_WARRIOR] = _("Night Warrior"),
    [ABILITY_GRAVE_WARDEN] = _("Grave Warden"),
    [ABILITY_DESERT_SPIRIT] = _("Desert Spirit"),
    [ABILITY_AIR_SUPERIORITY] = _("Air Superiority"),
    [ABILITY_VENOMOUS] = _("Venomous"),
    [ABILITY_AVIAN] = _("Avian"),
    [ABILITY_BKC] = _("BKC"),
    [ABILITY_CONFLAGRATE] = _("Conflagrate"),
    [ABILITY_UMBRAL_MIRROR] = _("Umbral Mirror"),
    [ABILITY_SPIRIT_CALL] = _("Spirit Call"),
    [ABILITY_IMPERIAL] = _("Imperial"),
    [ABILITY_SERAPHIM] = _("Seraphim"),
    [ABILITY_INFERNAL] = _("Infernal"),
    [ABILITY_GREAT_SAGE] = _("Great Sage"),
    [ABILITY_GRAVITY_WELL] = _("Gravity Well"),
    [ABILITY_LIVING_MELODY] = _("Living Melody"),
    [ABILITY_FAE_WARD] = _("Fae Ward"),
    [ABILITY_NASTY_TRICKS] = _("Nasty Tricks"),
    [ABILITY_RENEGADE] = _("RENEGADE"),
    [ABILITY_WORLD_SOUL] = _("World Soul"),
    [ABILITY_FLETCHER] = _("Fletcher"),
    [ABILITY_GINGA] = _("Ginga"),
    [ABILITY_VORPAL] = _("Vorpal"),
    [ABILITY_PROTEON] = _("Proteon"),
    [ABILITY_SLIPSTREAM] = _("Slipstream"),
    [ABILITY_STARCHILD] = _("Starchild"),
    [ABILITY_DRAKESCALE] = _("Drakescale"),
    [ABILITY_MECH_PILOT] = _("Mech Pilot"),
    [ABILITY_INSULATED] = _("Insulated"),
    [ABILITY_HARD_ROCK] = _("Hard Rock"),
    [ABILITY_ASSASSIN_FIST] = _("Assassin Fist"),
    [ABILITY_STAGGER] = _("Stagger"),
    [ABILITY_FROSTBROOD] = _("Frostbrood"),
    [ABILITY_POWER_CORE] = _("Power Core"),
    [ABILITY_SINBEARER] = _("Sinbearer"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_BUNNY_HOP] = sBunnyHopDescription,
    [ABILITY_MOLTEN_CORE] = sMoltenCoreDescription,
    [ABILITY_NIGHT_WARRIOR] = sNightWarriorDescription,
    [ABILITY_GRAVE_WARDEN] = sGraveWardenDescription,
    [ABILITY_DESERT_SPIRIT] = sDesertSpiritDescription,
    [ABILITY_AIR_SUPERIORITY] = sAirSuperiorityDescription,
    [ABILITY_VENOMOUS] = sVenomousDescription,
    [ABILITY_AVIAN] = sAvianDescription,
    [ABILITY_BKC] = sBkcDescription,
    [ABILITY_CONFLAGRATE] = sConflagrateDescription,
    [ABILITY_UMBRAL_MIRROR] = sUmbralMirrorDescription,
    [ABILITY_SPIRIT_CALL] = sSpiritCallDescription,
    [ABILITY_IMPERIAL] = sImperialDescription,
    [ABILITY_SERAPHIM] = sSeraphimDescription,
    [ABILITY_INFERNAL] = sInfernalDescription,
    [ABILITY_GREAT_SAGE] = sGreatSageDescription,
    [ABILITY_GRAVITY_WELL] = sGravityWellDescription,
    [ABILITY_LIVING_MELODY] = sLivingMelodyDescription,
    [ABILITY_FAE_WARD] = sFaeWardDescription,
    [ABILITY_NASTY_TRICKS] = sNastyTricksDescription,
    [ABILITY_RENEGADE] = sRenegadeDescription,
    [ABILITY_WORLD_SOUL] = sWorldSoulDescription,
    [ABILITY_FLETCHER] = sFletcherDescription,
    [ABILITY_GINGA] = sGingaDescription,
    [ABILITY_VORPAL] = sVorpalDescription,
    [ABILITY_PROTEON] = sProteonDescription,
    [ABILITY_SLIPSTREAM] = sSlipstreamDescription,
    [ABILITY_STARCHILD] = sStarchildDescription,
    [ABILITY_DRAKESCALE] = sDrakescaleDescription,
    [ABILITY_MECH_PILOT] = sMechPilotDescription,
    [ABILITY_INSULATED] = sInsulatedDescription,
    [ABILITY_HARD_ROCK] = sFilterDescription,
    [ABILITY_ASSASSIN_FIST] = sAssassinFistDescription,
    [ABILITY_STAGGER] = sStaggerDescription,
    [ABILITY_FROSTBROOD] = sFrostbroodDescription,
    [ABILITY_POWER_CORE] = sPowerCoreDescription,
    [ABILITY_SINBEARER] = sSinbearerDescription,
