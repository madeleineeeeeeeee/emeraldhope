const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_WEEDLE]                = {{EVO_LEVEL, 14, SPECIES_KAKUNA}},
    [SPECIES_KAKUNA]                = {{EVO_LEVEL, 27, SPECIES_BEEDRILL}},
    [SPECIES_PIDGEY]                = {{EVO_LEVEL, 14, SPECIES_PIDGEOTTO}},
    [SPECIES_PIDGEOTTO]             = {{EVO_LEVEL, 33, SPECIES_PIDGEOT}},
    [SPECIES_RATTATA]               = {{EVO_LEVEL, 20, SPECIES_RATICATE}},
    [SPECIES_SPEAROW]               = {{EVO_LEVEL, 20, SPECIES_FEAROW}},
    [SPECIES_EKANS]                 = {{EVO_LEVEL, 27, SPECIES_ARBOK}},
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                        {EVO_LEVEL, 31, SPECIES_RAICHU},
                                       {EVO_MOVE, MOVE_SURF, SPECIES_RAICHU_ALOLAN},
                                       {EVO_ITEM_HOLD, ITEM_BLACK_BELT, SPECIES_PIKACHU_LIBRE}},
    [SPECIES_SANDSHREW]             = {{EVO_LEVEL, 27, SPECIES_SANDSLASH}},
    //[SPECIES_NIDORAN_F]             = {{EVO_LEVEL, 21, SPECIES_NIDORINO}},
    //[SPECIES_NIDORINA]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDORAN_M]             = {{EVO_LEVEL, 21, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]              = {{EVO_LEVEL, 44, SPECIES_NIDOKING}},
    [SPECIES_CLEFAIRY]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]                = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF]            = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_WIGGLYTUFF}},
    [SPECIES_ZUBAT]                 = {{EVO_LEVEL, 27, SPECIES_CROBAT}},
    ...
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 33, SPECIES_RAPIDASH}},
    ...
    [SPECIES_MAGNETON]              = {//{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_MAGNEZONE},
                                       {EVO_LEVEL, 37, SPECIES_MAGNEZONE}},
#endif
    [SPECIES_DODUO]                 = {{EVO_LEVEL, 31, SPECIES_DODRIO}},
    [SPECIES_SEEL]                  = {{EVO_LEVEL, 31, SPECIES_DEWGONG}},
    ...
    [SPECIES_ONIX]                  = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
                                       {EVO_MOVE, MOVE_IRON_DEFENSE, SPECIES_STEELIX}},
...
#endif
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 29, SPECIES_WEEZING_GALARIAN}},
    [SPECIES_RHYHORN]               = {{EVO_LEVEL, 29, SPECIES_RHYDON}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_RHYDON]                = {{EVO_TRADE_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR},
                                       {EVO_MOVE, MOVE_ROCK_WRECKER, SPECIES_RHYPERIOR}},
#endif
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_ELECTABUZZ]            = {{EVO_LEVEL, 33, SPECIES_ELECTIVIRE},
                                       {EVO_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_LEVEL, 33, SPECIES_MAGMORTAR},
                                       {EVO_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}},
#endif
    [SPECIES_MAGIKARP]              = {{EVO_LEVEL, 38, SPECIES_GYARADOS}},
    ...
    [SPECIES_SENTRET]               = {{EVO_LEVEL, 25, SPECIES_FURRET}},
    [SPECIES_HOOTHOOT]              = {{EVO_LEVEL, 20, SPECIES_NOCTOWL}},
    [SPECIES_LEDYBA]                = {{EVO_LEVEL, 18, SPECIES_LEDIAN}},
    [SPECIES_SPINARAK]              = {{EVO_LEVEL, 25, SPECIES_ARIADOS}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_SNEASEL]               = {{EVO_MOVE, MOVE_ICICLE_CRASH, SPECIES_WEAVILE}},
                                       //{EVO_ITEM_NIGHT, ITEM_RAZOR_CLAW, SPECIES_WEAVILE}},
#endif
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 27, SPECIES_URSARING}},
    ...
    [SPECIES_HOUNDOUR]              = {{EVO_LEVEL, 28, SPECIES_HOUNDOOM}},
    [SPECIES_PHANPY]                = {{EVO_LEVEL, 29, SPECIES_DONPHAN}},
    //[SPECIES_DONPHAN]               = {{EVO_LEVEL, 46, SPECIES_PHANTUSKODON}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_LARVITAR]              = {{EVO_LEVEL, 26, SPECIES_PUPITAR}},
    [SPECIES_PUPITAR]               = {{EVO_LEVEL, 47, SPECIES_TYRANITAR}},
    ...
    [SPECIES_WURMPLE]               = {{EVO_MOVE, MOVE_SILVER_WIND, SPECIES_SILCOON},
                                       {EVO_MOVE, MOVE_ACID, SPECIES_CASCOON}},
    [SPECIES_SILCOON]               = {{EVO_LEVEL, 26, SPECIES_BEAUTIFLY}},
    [SPECIES_CASCOON]               = {{EVO_LEVEL, 26, SPECIES_DUSTOX}},
    ...
    [SPECIES_NINCADA]               = {{EVO_LEVEL_NINJASK, 28, SPECIES_NINJASK},
                                       {EVO_LEVEL_SHEDINJA, 28, SPECIES_SHEDINJA}},
    [SPECIES_TAILLOW]               = {{EVO_LEVEL, 28, SPECIES_SWELLOW}},
    [SPECIES_SHROOMISH]             = {{EVO_LEVEL, 28, SPECIES_BRELOOM}},
    [SPECIES_WINGULL]               = {{EVO_LEVEL, 25, SPECIES_PELIPPER}},
    [SPECIES_SURSKIT]               = {{EVO_LEVEL, 24, SPECIES_MASQUERAIN}},
    ...
    [SPECIES_SWABLU]                = {{EVO_LEVEL, 40, SPECIES_ALTARIA}},
    [SPECIES_WYNAUT]                = {{EVO_LEVEL, 15, SPECIES_WOBBUFFET}},
    [SPECIES_DUSKULL]               = {{EVO_LEVEL, 27, SPECIES_DUSCLOPS}},
#if P_GEN_4_POKEMON == TRUE
...
#endif
    [SPECIES_SLAKOTH]               = {{EVO_MOVE, MOVE_UPROAR, SPECIES_VIGOROTH},
    ...
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 44, SPECIES_AGGRON}},
    ...
    [SPECIES_SHELGON]               = {{EVO_LEVEL, 46, SPECIES_SALAMENCE}},
    ...
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 33, SPECIES_SAMUROTT},
    ...
    [SPECIES_ROGGENROLA]            = {{EVO_LEVEL, 24, SPECIES_BOLDORE}},
    [SPECIES_BOLDORE]               = {{EVO_MOVE, MOVE_ROCK_POLISH, SPECIES_GIGALITH}},
    ...
    [SPECIES_SEWADDLE]              = {{EVO_LEVEL, 19, SPECIES_SWADLOON}},
    [SPECIES_SWADLOON]              = {{EVO_LEVEL, 39, SPECIES_LEAVANNY}},
    [SPECIES_VENIPEDE]              = {{EVO_LEVEL, 22, SPECIES_WHIRLIPEDE}},
    [SPECIES_WHIRLIPEDE]            = {{EVO_LEVEL, 39, SPECIES_SCOLIPEDE}},
    [SPECIES_COTTONEE]              = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_WHIMSICOTT}},
    [SPECIES_PETILIL]               = {{EVO_MOVE, MOVE_PETAL_DANCE, SPECIES_LILLIGANT_HISUIAN}},
                                       //{EVO_NONE, 0, SPECIES_LILLIGANT_HISUIAN}},
    [SPECIES_SANDILE]               = {{EVO_LEVEL, 24, SPECIES_KROKOROK}},
    [SPECIES_KROKOROK]              = {{EVO_LEVEL, 39, SPECIES_KROOKODILE}},
    ...
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 37, SPECIES_KLINKLANG}},
    ...
    [SPECIES_LAMPENT]               = {{EVO_MOVE, MOVE_FIRE_BLAST, SPECIES_CHANDELURE}},
    ...
    [SPECIES_SHELMET]               = {{EVO_LEVEL, 32, SPECIES_ESCAVALIER}},
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 33, SPECIES_MIENSHAO}},
    ...
    [SPECIES_DEINO]                 = {{EVO_LEVEL, 28, SPECIES_ZWEILOUS}},
    [SPECIES_ZWEILOUS]              = {{EVO_LEVEL, 46, SPECIES_HYDREIGON}},
    ...
    [SPECIES_FLETCHINDER]           = {{EVO_LEVEL, 34, SPECIES_TALONFLAME}},
    [SPECIES_SCATTERBUG]            = {{EVO_LEVEL, 28, SPECIES_VIVILLON}},
    ...
    [SPECIES_FLOETTE]               = {{EVO_LEVEL, 40, SPECIES_FLORGES}},
    ...
    [SPECIES_HONEDGE]               = {{EVO_LEVEL, 25, SPECIES_DOUBLADE}},
    ...
    [SPECIES_TYRUNT]                = {{EVO_MOVE, MOVE_DRAGON_RUSH, SPECIES_TYRANTRUM}},
    [SPECIES_AMAURA]                = {{EVO_MOVE, MOVE_BLIZZARD, SPECIES_AURORUS}},
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 26, SPECIES_SLIGGOO},
                                       {EVO_MOVE, MOVE_WITHDRAW, SPECIES_SLIGGOO_HISUIAN}},
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL_RAIN, 42, SPECIES_GOODRA},
                                       {EVO_LEVEL_FOG, 42, SPECIES_GOODRA}},
    [SPECIES_SLIGGOO_HISUIAN]       = {{EVO_LEVEL_RAIN, 42, SPECIES_GOODRA_HISUIAN},
                                       {EVO_LEVEL_FOG, 42, SPECIES_GOODRA_HISUIAN}},
    [SPECIES_PHANTUMP]              = {{EVO_MOVE, MOVE_SCARY_FACE, SPECIES_TREVENANT}},
                                       //{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_MOVE, MOVE_FIRE_BLAST, SPECIES_GOURGEIST}},
    ...
    [SPECIES_LITTEN]                = {{EVO_LEVEL, 38, SPECIES_TORRACAT}},
    ...
    [SPECIES_TRUMBEAK]              = {{EVO_LEVEL, 33, SPECIES_TOUCANNON}},
    ...
    [SPECIES_ROCKRUFF]              = {{EVO_LEVEL, 28, SPECIES_LYCANROC},
    ...
    [SPECIES_DEWPIDER]              = {{EVO_LEVEL, 28, SPECIES_ARAQUANID}},
    ...
    [SPECIES_COSMOEM]               = {{EVO_MOVE, MOVE_MORNING_SUN, SPECIES_SOLGALEO},
                                       {EVO_MOVE, MOVE_SHADOW_BALL, SPECIES_LUNALA}},
    ...
    [SPECIES_TOXEL]                 = {{EVO_MOVE, MOVE_UPROAR, SPECIES_TOXTRICITY},
    ...
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 29, SPECIES_MORGREM}},
    ...
    [SPECIES_SNOM]                  = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_FROSMOTH},
                                        {EVO_LEVEL, 41, SPECIES_FROSMOTH}},
    [SPECIES_CUFANT]                = {{EVO_LEVEL, 34, SPECIES_COPPERAJAH}},
    [SPECIES_DREEPY]                = {{EVO_LEVEL, 26, SPECIES_DRAKLOAK}},
...
#endif
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_LEVEL, 33, SPECIES_RAPIDASH_GALARIAN}},
    ...
    [SPECIES_LINOONE_GALARIAN]      = {{EVO_LEVEL, 38, SPECIES_OBSTAGOON}},
    ...
    [SPECIES_FLOETTE_YELLOW_FLOWER] = {{EVO_LEVEL, 40, SPECIES_FLORGES_YELLOW_FLOWER}},
    [SPECIES_FLOETTE_ORANGE_FLOWER] = {{EVO_LEVEL, 40, SPECIES_FLORGES_ORANGE_FLOWER}},
    [SPECIES_FLOETTE_BLUE_FLOWER]   = {{EVO_LEVEL, 40, SPECIES_FLORGES_BLUE_FLOWER}},
    [SPECIES_FLOETTE_WHITE_FLOWER]  = {{EVO_LEVEL, 40, SPECIES_FLORGES_WHITE_FLOWER}},
    ...
    [SPECIES_URSARING]              = {{EVO_MOVE, MOVE_REST, SPECIES_URSALUNA}},
