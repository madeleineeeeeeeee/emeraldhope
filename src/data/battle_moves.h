const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_HYPER_BEAM] =
    {
        .effect = EFFECT_RECOIL_DROP_SPATK,
        .power = 140,
        .type = TYPE_NORMAL,
        .accuracy = 90,
        .pp = 8,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .type = TYPE_STEEL,
        .accuracy = 100,
        .secondaryEffectChance = 0, // 50% Defense down, 30% Flinch. Can be modified in 'SetMoveEffect'
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_LAST_RESPECTS] =
    {
        .effect = EFFECT_HIT, // EFFECT_LAST_RESPECTS
        .power = 70,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 16,
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        .effect = EFFECT_ALWAYS_CRIT, // EFFECT_GLAIVE_RUSH
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 8,
    ...
    [MOVE_BROADSIDE] =
    {
        .effect =  EFFECT_HIT_ESCAPE_RECOIL,
        .power = 60,
        .type = TYPE_STEEL,
        .accuracy = 90,
        .pp = 8,
