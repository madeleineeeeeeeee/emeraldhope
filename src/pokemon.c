...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    //SPECISE_TO_NATIONAL(PHANTUSKODON),
    //SPECIES_TO_NATIONAL(PORYGON2),
    ...
    */
    ...
    SPECIES_TO_NATIONAL(LARVENOM),
    SPECIES_TO_NATIONAL(MOTHROXIN),
    */
    ...
    //SPECIES_TO_NATIONAL(ZHUAMUNTANG),
    //SPECIES_TO_NATIONAL(BASILIKUNE),
    SPECIES_TO_NATIONAL(GALLADIN),
    ...
    //SPECIES_TO_NATIONAL(PIKACHULIBRE)
#endif
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_PIDGEOT - 1]       = ANIM_ZIGZAG_SLOW,
    ...
    [SPECIES_GALLADIN - 1]       = ANIM_H_SLIDE,
    ...
    [SPECIES_DRAGALGE - 1]      = ANIM_V_SLIDE_SLOW,
    ...
    [SPECIES_YVELTAL - 1]       = ANIM_V_SHAKE,
