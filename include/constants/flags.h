...
#define FLAG_ODD_FOREST_ENTER  0x2AA // Unused Flag
...
#define FLAG_HIDE_FLORIST                      0x38A
...
#define FLAG_LITTLEROOT_LUMBERRY                    (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_LITTLEROOT_ORANBERRY                   (SYSTEM_FLAGS + 0x86) // Unused Flag
